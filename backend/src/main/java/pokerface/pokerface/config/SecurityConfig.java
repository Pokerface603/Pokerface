...
import pokerface.pokerface.config.oauth.handler.OAuth2LoginFailureHandler;
import pokerface.pokerface.config.oauth.handler.OAuth2LoginSuccessHandler;
import pokerface.pokerface.config.oauth.service.CustomOAuth2UserService;
...
//						.anyRequest().permitAll();
				...
				.antMatchers("/",  "/members","/members/check/email/**", "/members/check/nickname/**"
						...
						"/api/swagger-ui/**","/swagger-resources/**", "/swagger-ui.html","/swagger-ui/**", "ws/lobby").permitAll()
